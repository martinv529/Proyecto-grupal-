...
def mostrar_menu():
    ...
    print("3. Estadísticas de ventas por articulos")
    print("4. Estadísticas de ventas por clientes")
    print("5. Estadísticas de ventas por producto en específico ")
    print("6. Estadísticas de ventas por cliente en específico ")
    print("7. Salir")

def obtener_opcion(menu):
    """
    Función para obtener una opción válida de los menús.
    Retorna un valor entero si la entrada es válida, o False si no lo es.
    """
    try:
        ...
        return False  # Retorna False si la opción es inválida

bandera = True
while bandera:
    mostrar_menu()

    eleccion = obtener_opcion("Seleccione su opción (1-7): \n")
    if eleccion == False:
    ...
    if eleccion == 1:
        while True:
            ...
            opcion = obtener_opcion("Seleccione su opción (1-5): \n")
            if opcion == False:
                continue  # Si la opción no es válida, sigue mostrando el submenú
